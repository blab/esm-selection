...
parser.add_argument("--time", default="1991", help="Time to filter sequences (supports decimal years like 2009.264)")
...
node_times_trim = {key: val for key, val in node_times.items() if val < time_cutoff}
